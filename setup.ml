...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4fdec924a1c5889357cf3a58d1b7927) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Armael/ocaml-i3ipc";
          bugreports = None;
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "i3_msg.ml"})
            ];
     ...
     oasis_digest =
       Some "\199\220\217\188\179\015\226\245\026\135\173\0224b\204\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
